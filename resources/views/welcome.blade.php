            ...
            <div class="container">
                <div class="col-md-12">
                    <div id="main-slider">
                        ...
                        <div class="item">
                            <img class="img-responsive" src="img/shirt.jpg" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="img/celana.jpg" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="img/topi.jpg" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="img/sepatu.jpg" alt="">
                        </div>
                    </div>
                    <!-- /#main-slider -->
                </div>
                       ...
                       @foreach($data as $key)
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="detail.html">{{$key->judul}}</a></h3>
                                    <h3>{{$key->ket}}</h3>
                                </div>
                                <!-- /.text -->
