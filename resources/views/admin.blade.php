...
<head>
    ...
    <link rel="{{ url('assets/stylesheet')}}" type="text/css" href="css/maps/jquery-jvectormap-2.0.1.css" />
...
@yield('content')   
    ...
    <script type="text/javascript" src="{{ url ('assets/js/flot/jquery.flot.js')}}"></script>
    <script type="text/javascript" src="{{ url ('assets/js/flot/jquery.flot.pie.js')}}"></script>
    <script type="text/javascript" src="{{ url ('assets/js/flot/jquery.flot.orderBars.js')}}"></script>
    <script type="text/javascript" src="{{ url ('assets/js/flot/jquery.flot.time.min.js')}}"></script>
    <script type="text/javascript" src="{{ url ('assets/js/flot/date.js')}}"></script>
    <script type="text/javascript" src="{{ url ('assets/js/flot/jquery.flot.spline.js')}}"></script>
    <script type="text/javascript" src="{{ url ('assets/js/flot/jquery.flot.stack.js')}}"></script>
...
return true;
    ...
    <!-- worldmap -->
    <script type="text/javascript" src="{{ url('assets/js/maps/jquery-jvectormap-2.0.1.min.js')}}"></script>
...
<script type="text/javascript">
    ...
    <!-- skycons -->
    <script src="{{ url('assets/js/skycons/skycons.js')}}"></script>
    <script>
    ...
    <!-- /dashbord linegraph -->
    <!-- datepicker -->
    <script type="{{ url ('assets/text/javascript')}}">
        $(document).ready(function () {
